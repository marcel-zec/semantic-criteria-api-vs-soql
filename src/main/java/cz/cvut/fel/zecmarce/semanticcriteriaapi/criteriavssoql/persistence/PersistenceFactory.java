package cz.cvut.fel.zecmarce.semanticcriteriaapi.criteriavssoql.persistence;
...
public class PersistenceFactory {
    ...
    private void init() {
        ...
        props.put(JOPAPersistenceProperties.SCAN_PACKAGE, "cz.cvut.fel.zecmarce.semanticcriteriaapi.criteriavssoql");
        // Ontology language
        ...
        this.emf = Persistence.createEntityManagerFactory("criteriaSoqlComparisonPU", props);
    }
